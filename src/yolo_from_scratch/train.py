...
from src.yolo_from_scratch.dataset import CustomDataset
...
def objective(trial):
    ...
    train_dataset = CustomDataset(
        root_dir="src/yolo_from_scratch/dataset/train", transform=transform
    )
    val_dataset = CustomDataset(
        root_dir="src/yolo_from_scratch/dataset/val", transform=transform
    )
