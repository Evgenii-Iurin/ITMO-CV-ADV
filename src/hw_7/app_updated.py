...
from src.hw_7.custom_model import HandKeypointModel

from src.hw_7.gest_checking_updated import (
...
def main():
    ...
    parser.add_argument("--use-mymodel", action="store_true", help="Use custom PyTorch model")
    ...
    background = load_background(Path(args.background) if args.background else None, first_frame.shape)
    ...
    if use_model:
        model_path = "src/hw_7/assets/resnet_based_model.pt"
    ...
    try:
        while True:
            ...
            if use_model:
                ...
                elif is_open_palm([type("Dummy", (), {"y": y, "x": x}) for x, y in pred_kpts]):
                    prev_point = None
